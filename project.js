...
const chr=document.getElementById("ch");
var upd;
form.addEventListener('submit',(e)=>{
	...
	chr.classList.add('mainClick');
    chr.classList.remove('main'); 
	fetchPrice(ctype);
...
const fetchPrice = async(ctype) =>{
    ...
    res.innerHTML =`<tr style ="background-color:skyblue; color:white; font-weight:700">
    <td>
       Property
    </td>
    <td>
